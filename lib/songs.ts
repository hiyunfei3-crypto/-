export type Song = { id: number; title: string; artist: string; note?: string; url?: string; isSC?: boolean; active?: boolean };
...
export let songs: Song[] = [
  ...
  },
  {
    "id": 194,
    "title": "喀秋莎",
    "artist": "Георгий Виноградов / Эстрадный оркестр Всесоюзного радио / Виктор Кнушевицкий"
  },
  {
    "id": 195,
    "title": "广寒宫",
  ...
  },
  {
    "id": 334,
    "title": "就是哪吒",
    "artist": "若见音社 / 乐白 / 女夭忄圣 / 有才YoCHAi / 唱酱酱酱酱"
  },
  {
    "id": 335,
    "title": "百战成诗",
    "artist": "令狐襄儿 / 兰音Reine / 马正阳 / 潘寅生"
  },
  {
    "id": 336,
    "title": "莫问归期",
  ...
  },
  {
    "id": 381,
    "title": "不想长大",
    "artist": "贝拉Bella / 嘉然Diana / 乃琳Eileen / 咬一口果丹皮"
  },
  {
    "id": 382,
    "title": "母系社会",
  ...
  },
  {
    "id": 485,
    "title": "北京东路的日子",
    "artist": "汪源 / 刘千楚 / 徐逸昊 / 鲁天舒 / 姜玮珉 / 胡梦原 / 张鎏依 / 梁竞元 / 游彧涵 / 金书援 / 许一璇 / 张夙西"
  },
  {
    "id": 486,
    "title": "青春修炼手册",
...
export function titleLength(song: Song) { return Array.from(song.title.replace(/\(sc\)$/i, '').replace(/\s/g, '')).length; }
export function matchesCategory(song: Song, category: string) {
 const n = titleLength(song);
 return category === '全部' || (category === 'SC' ? isSC(song) : category === '1–2字' ? n <= 2 : category === '3字' ? n === 3 : category === '4字' ? n === 4 : category === '5字及以上' ? n >= 5 : false);
}
